...
export default class SuggestionController {
    ...
    addAntonyms(data) {
        return this.model.addSuggestions('antonyms', data.serial, data.word, sanitize(data.suggestions));
    }

    addExamples(data) {
        return this.model.addSuggestions('examples', data.serial, data.word, sanitize(data.suggestions));
    }

    addSynonyms(data) {
        return this.model.addSuggestions('synonyms', data.serial, data.word, sanitize(data.suggestions));
    }
