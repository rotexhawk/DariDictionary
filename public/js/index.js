...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dari = __webpack_require__(55);
	...
	function convert(event) {
	    ...
	    if ($('.header-search-tabs button.active').data('search-url') === '/dari') {
	        var searchedStr = (0, _dari.toDari)($(this).val(), event.shiftKey);
	...
	function autoSuggest(event) {
	    ...
	    //     return;
	    // }
	    var urlPath = $('.header-search-tabs button.active').data('search-url');
	    if (timer) {
	        clearTimeout(timer);
	    }
	    timer = setTimeout(function () {
	        $.ajax('/api' + urlPath + '/words/' + $(self).val()).done(updateAutoSuggest).fail(function (error) {
	...
	function notValidKey(keyCode) {
	    ...
	    var keyArrs = [undefined, 37, 38, 39, 40, 20, 16, 17, 18, 19, 27, 33, 35, 43, 36, 45, 93, 112];
	    return keyArrs.includes(keyCode);
	}
	
	function updateAutoSuggest(words) {
	    if (!Array.isArray(words)) {
	        words = (0, _from2.default)(words);
	    }
	    var html = words.reduce(function (acc, curr) {
	...
	function setSearchButtons(event) {
	    if (event.target.nodeName === 'BUTTON') {
	        $(this).find('button').each(function (index, elm) {
	...
	function submitSuggestion(event) {
	    event.preventDefault();
	    var suggestions = $(this).closest('.suggest-form').find('textarea').val();
	    if (suggestions.length > 0) {
	        var urlPath = $('.header-search-tabs button.active').data('search-url');
	        var url = '/api' + urlPath + '/suggestions/';
	...
	function sendToServer(suggestions, url) {
	    $.post(url, suggestions.serialize()).done(function (response) {
	...
	function pageLoadAnimations() {
	    $('.animate').each(function (index, elm) {
	        return animate(null, elm, removeURLParams);
	    });
	}
	...
	function submitSignupForm(event) {
	    ...
	    var note = '<p class="italic text-center padding-top-normal text-smaller animate border-bottom-small" data-animation="fadeIn">\n    Thank you for signing up. Please check your inbox for confirmation email.</p>';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.toDari = toDari;
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var keyboardMap = [{ "]": "چ" }, { "[": "ج" }, { "p": "ح" }, { "o": "خ" }, { "i": "ه" }, { "u": "ع" }, { "y": "غ" }, { "t": "ف" }, { "r": "ق" }, { "e": "ث" }, { "w": "ص" }, { "q": "ص" }, { "'": "گ" }, { ";": "ک" }, { "l": "م" }, { "k": "ن" }, { "j": "ت" }, { "h": "ا" }, { "g": "ل" }, { "f": "ب" }, { "d": "ی" }, { "s": "س" }, { "a": "ش" }, { ",": "و" }, { "m": "پ" }, { "n": "د" }, { "b": "ذ" }, { "v": "ر" }, { "c": "ز" }, { "x": "ط" }, { "z": "ظ" }, { "1": "۱" }, { "2": "۲" }, { "3": "۳" }, { "4": "۴" }, { "5": "۵" }, { "6": "۶" }, { "7": "۷" }, { "8": "۸" }, { "9": "۹" }, { "0": "۰" }];
	
	var shiftMap = [{ "}": "{" }, { "{": "}" }, { "P": "[" }, { "O": "]" }, { "I": "ّ" }, { "U": "َ" }, { "Y": "ِ" }, { "T": "ُ" }, { "R": "ً" }, { "E": "ٍ" }, { "W": "ٌ" }, { "Q": "ْ" }, { "'": "؛" }, { "L": "»" }, { "K": "«" }, { "J": "ة" }, { "H": "آ" }, { "G": "أ" }, { "F": "إ" }, { "D": "ي" }, { "S": "ئ" }, { "A": "ؤ" }, { "?": "؟" }, { "M": "ء" }, { "N": "ٔ" }, { "B": "" }, { "V": "ٰ" }, { "C": "ژ" }, { "X": "ٓ" }, { "Z": "ك" }, { "@": "٬" }, { "#": "٫" }, { "$": "؋" }, { "%": "٪" }, { "^": "×" }, { "&": "،" }, { "(": ")" }, { ")": "(" }];
	...
	function convertToDari(str, mappingArr) {
	    ...
	    return str.map(function (char) {
	        ...
	        return mappingArr.filter(function (mapChar) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	( function( factory ) {
		if ( true ) {
			...
			!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(1), __webpack_require__(65) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
		} else {
